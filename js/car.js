const data = [
    ...
    },
    {
      ...
      price: "221",
      description:
        "Vehicle Type: Sedan, Doors: 2, Seats: 2, Luggage: 3 Suitcases / 3 Bags, Transmission: Manual",
  ...
  const displayCar = cars => {
    ...
    <a href="#">
        <img class="rounded-t-lg" src=" ${car.imageURL} " alt="" />
    </a>
    <div class="p-5">
        <a href="#">
            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white"> ${car.name} </h5>
        </a>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Car Details : ${car.description} </p>
